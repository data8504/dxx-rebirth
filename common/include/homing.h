 ...
 */
[[nodiscard]]
static inline homing_turn_result homing_turn_velocity(vms_vector velocity, vms_vector vector_to_object, const fix max_speed, const fix turn_time, const bool double_target_vector)
{
...
[[nodiscard]]
static inline vms_matrix homing_turn_orientation(const vms_matrix &orientation, vms_vector normalized_velocity, const fix turn_time, const fix orientation_scale)
{
